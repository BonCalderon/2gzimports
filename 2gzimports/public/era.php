...
$page_title = "Browse by Era || 2Gz Imports Garage";
...
<section class="about-section text-center" id="about">
    ...
    <section class="row justify-content-between my-5">
        ...
        <div class="text-center">
            <h2 class="display-4">Browsd By Era</h2>
    ...
    <nav class = "text-center ">
        <a href="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>?year=1&min=1950&max=1970" class="btn btn-outline-dark mx-2 mt-3">1950 - 1970</a>
        <a href="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>?year=2&min=1971&max=1990" class="btn btn-outline-dark mx-2 mt-3">1971 - 1990</a>
        <a href="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>?year=3&min=1991&max=2010" class="btn btn-outline-dark mx-2 mt-3">1991 - 2010</a>
        <a href="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>?year=4&min=2011&max=2025" class="btn btn-outline-dark mx-2 mt-3">2011+</a>
    </nav>
    </section>
        ...
        <div class="container">
            ...
            else
            {
                ...
                echo "</table>";
                    ...
                    echo "<h2 class='text-center text-dark'>No Cars in that Era, Please upload more!</h2>";
